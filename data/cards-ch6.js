window.CARDS_CH6 = [
    ...
    },
    {
        ...
        chapter: 6,
        term: "フル・差分・増分バックアップ",
        definition: "フルは全消去、差分はフル以降の変更分、増分は前回のバックアップ以降の変更分。",
    ...
    },
    {
        ...
        chapter: 6,
        term: "コンパイラ最適化",
        definition: "プログラムの動作（外部仕様）を変えずに、実行速度向上やサイズ削減のためにコードを書き換えること。",
...
// ... 以降、ch6のアップロード内容に基づき、ID 0016〜0033まで同様のフォーマットで展開されます。