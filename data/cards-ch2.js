window.CARDS_CH2 = [
    {
        id: "ch2-0001", chapter: 2, term: "半加算器", definition: "1ビットの2入力を加算し，和(S)と桁上がり(C)を出力する回路。",
        extraExplain: "ポイント: 下位からの桁上がりを無視する「半分」の機能しか持たない回路。\nひっかけ: 「下位桁からの桁上がり(Cin)も加算する」という記述があれば、それは「全加算器」の説明。\n例: XORとAND回路の組み合わせで1ビット分だけ計算する。\n暗記：1ビット・桁上がり無視・XOR/AND"
    },
    {
    ...
    },
    {
        ...
        extraExplain: "ポイント: eXtensible（拡張可能）の名前通り、自分でタグを作れる。\nひっかけ: 「タグの種類や使い方が規定されている」はHTMLの説明。XMLは「自由」がキーワード。\n例: <price>100</price> のように独自のタグでデータを記述できる。\n暗記：独自タグ・拡張性・メタ言語"
    }
];